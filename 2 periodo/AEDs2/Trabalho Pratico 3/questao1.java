...
class Games {
    ...
    void imprimirAVG() {
        ...
        if (minutosPassados > 0)
            System.out.print(minutosPassados + "m ");
        else
            System.out.print("");
    }
...
class Lista {
    ...
    public void sort() {
        for (int i = 0; i < (n - 1); i++) {
            int menor = i;
            for (int j = (i + 1); j < n; j++) {
                if (array[menor].getName().compareTo(array[j].getName()) > 
                    array[j].getName().compareTo(array[menor].getName())) {
                    menor = j;
                    count++;
                }
            }
